                    ...
                    <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                        <a href="profile.html" class="">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="right">
                                    <h6 class="mb-1 font-weight-bold">Kami <i class="feather-check-circle text-success"></i></h6>
                                    <p class="text-muted m-0 small">tetsuya.kamijo@white-sands.biz</p>
                                </div>
                            </div>
                        </a>
                        <div class="osahan-credits d-flex align-items-center p-3 bg-light">
                            <p class="m-0">今月の売上</p>
                            <h5 class="m-0 ml-auto text-primary">23,000円</h5>
                        </div>
                        <!-- profile-details -->
                        <div class="bg-white profile-details">
                            <a href="privacy.html" class="d-flex w-100 align-items-center px-3 py-4">
                                <div class="left mr-3">
                                    <h6 class="font-weight-bold m-0 text-dark"><i class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i> 会員設定</h6>
                                </div>
                            ...
                            <a href="privacy.html" class="d-flex w-100 align-items-center px-3 py-4">
                                <div class="left mr-3">
                                    <h6 class="font-weight-bold m-0 text-dark"><i class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i> 通知設定</h6>
                                </div>
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                                </div>
                        ...
                        <div class="osahan-privacy bg-white rounded shadow-sm p-4">
                            ...
                            <div id="privacy" class="mb-4">
                                ...
                                <p>We provide information to help copyright holders manage their intellectual property online. If you think somebody is violating your copyrights and want to notify us, you can find information about submitting notices and
                                    Swiggiweb's policy about responding to notices in <a href="help.html">our Help Center</a>.
                                </p>
                            </div>
