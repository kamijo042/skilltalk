                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                  講義をご予約したり講師にメッセージを送ることができます。<br>自身のスキルアップを目指し、興味のある講義や是非探してみてください。<br>
                                  それでは、講義が見つかることを願っております！
                                </div>
                              </td>
                            </tr>
                          </table>
                        ...
                        <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                          <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                  口コミやメッセージなどの機能を利用するには、会員情報の更新が必要です。<br>講師へスキルレベルを共有することで、自身にあったレベルでの講義を受けられます。
                                </div>
                              </td>
                            </tr>
                          </table>
                    ...
                    <tr>
                      <td style='direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;'>
                        <div class='dys-column-per-45 outlook-group-fix' style='font-size:13px;text-align:left;margin: 0 auto;'>
                            <div style="padding:24px;background-color: white;border: 1px solid #ccc;">
                                ...
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">上條哲也</div>
                                <div style="color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">メールアドレス</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">test@test.com</div>
                            </div>
                        </div>
                      </td>
                    </tr>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td style='width:130px;'>
                                                <img alt='Profile Picture' height='auto' src='http://127.0.0.1:8000/lecture-platform/ws/img/office01.jpg' style='border:1px solid #ccc;border-radius:5px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='130' />
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                    ...
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;' vertical-align='middle'>
                                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                                          <tr>
                                            <td align='center' bgcolor='#ff6f6f' role='presentation' style='background-color:#ff6f6f;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                              <a href='http://127.0.0.1:8000/lecture/detail/1' style='background:#ff6f6f;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                                講義ページ
                                              </a>
                                            </td>
                                          </tr>
      ...
      <div style="background: #f7f7f7;background-color: #f7f7f7;">
        <div style="margin: 0px auto;max-width: 600px;">
          ...
          <ul style="margin-bottom: 0px;">
            <li>このメールは、ココナラに会員登録されたお客様にお送りしています。</li>
            <li>このメールに心あたりが無い場合は、誠におそれいりますが、破棄していただけますようお願いいたします。</li>
