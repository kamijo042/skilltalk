...
<![endif]-->
      ...
      <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f7f7f7;background-color:#f7f7f7;width:100%;'>
        <tbody>
          <tr>
            <td>
              <div style='margin:0px auto;max-width:600px;padding-left: 8px;padding-right: 8px;'>
                <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
                  <tbody>
                    <tr>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                  下記のリンクから、パスワードリセットを行なってください。
                                  <br>有効期間は、パスワードリセット申請時刻から30分です。
                                </div>
                                    <div style='width: 148px;margin:16px;background-color:#ff6f6f;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                      <a href='{{$token_url}}' style='background:#ff6f6f;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                        パスワードのリセット
                                      </a>
                                    </div>
                              </td>
...
<![endif]-->
      ...
      <div style="background: #f7f7f7;background-color: #f7f7f7;">
        <div style="margin: 0px auto;max-width: 600px;">
          <div style="padding:8px 8px 0 8px;">【注意事項】</div>
          <div style="padding: 0px 24px 12px 0px">
          <ul style="margin-bottom: 0px;">
            <li>このメールは、スキルトークのパスワード変更していただいたお客様にお送りしています。</li>
            <li>心当たりのない場合は、大変お手数ですが、このメールを破棄していただくよう、お願いいたします。</li>
          </ul>
          <div>
        </div>
      </div>
