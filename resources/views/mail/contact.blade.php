            ...
            <td>
              <div style='margin:0px auto;max-width:600px;'>
                <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
                  <tbody>
                    <tr>
                      <td style='direction:ltr;font-size:0px;padding-top:20px;text-align:center;vertical-align:top;'>
                        <!--[if mso | IE]>
<table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:600px;">
<![endif]-->
                        <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                  ...
                  <tbody>
                    <tr>
                      <td style='direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;'>
                        <div class='dys-column-per-45 outlook-group-fix' style='font-size:13px;text-align:left;margin: 0 auto;'>
                            <div style="margin:0 16px;padding:24px;background-color: white;border: 1px solid #ccc;">
                                <div style="color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">氏名</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{{$param[0]}}</div>
                                <div style="margin-top:16px;color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">メールアドレス</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{{$to[0]}}</div>
                                <div style="margin-top:16px;color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">電話番号</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{{$param[1]}}</div>
                                <div style="margin-top:16px;color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">区分</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{{$param[2]}}</div>
                                <div style="margin-top:16px;color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">件名</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{{$param[3]}}</div>
                                <div style="margin-top:16px;color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;font-weight:700;line-height:25px;text-align:left;">内容</div>
                                <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:22px;text-align:left;">{!! nl2br(e($param[4])) !!}</div>
                            </div>
                        </div>
                      </td>
                    </tr>
      ...
      <div style="background: #f7f7f7;background-color: #f7f7f7;">
        <div style="margin: 0px auto;max-width: 600px;">
          ...
          <ul style="margin-bottom: 0px;">
            ...
            <br>　https://coconala-support.zendesk.com/hc/ja/</li>
          </ul>
          <div>
        </div>
      </div>
